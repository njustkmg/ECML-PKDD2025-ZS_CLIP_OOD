...
def set_ood_loader_ImageNet(args, out_dataset, preprocess, root):
    ...
    elif out_dataset == 'cifar100_easy':
        testsetout = torchvision.datasets.ImageFolder(root="/media/chaod/code/TaI-DPT/data/cifar100/easy_ood", transform=preprocess)
    elif out_dataset == 'cifar100_hard':
        testsetout = torchvision.datasets.ImageFolder(root="/media/chaod/code/TaI-DPT/data/cifar100/hard_ood", transform=preprocess)
