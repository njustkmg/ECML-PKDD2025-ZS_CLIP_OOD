...
def get_ood_scores_clip(args, net, loader, test_labels, in_dist=False):
    ...
    with open('/media/chaod/code/clip_ood/true/waterbird.json', 'r') as json_file:
        data = json.load(json_file)
    # with open('/media/chaod/code/clip_ood/waterbird_wordnet.json', 'r') as json_file:
        # data = json.load(json_file)
    # with open('/media/chaod/code/clip_ood/true/sun.json', 'r') as json_file:
        # data = json.load(json_file)
    with open('/media/chaod/code/llama-main/clip_ood_datasets/specific_descirbe/common/chatgpt_waterbird_name_to_describe.json', 'r') as f:
        descriptions = json.load(f)  
    # with open('/media/chaod/code/llama-main/clip_ood_datasets/specific_descirbe/chatgpt/chatgpt_imagenet10_name_to_describe.json', 'r') as f:
        # descriptions = json.load(f)    
    # with open('/media/chaod/code/llama-main/clip_ood_datasets/specific_descirbe/chatgpt/chatgpt_imagenet20_name_to_describe.json', 'r') as f:
        # descriptions = json.load(f)  
    ...
    with torch.no_grad():
        for batch_idx, (images, labels) in enumerate(tqdm_object): 
            ...
            if args.model == 'CLIP':
                ...
                # text_inputs = tokenizer([f"a photo of a {c} {descriptions.get(c,'')}" for c in test_labels_list2], padding=True, return_tensors="pt")
            ...
            if args.score == 'energy':
                ...
                for i in range(num_rows):
                    ...
                    # _score.append(-to_np((T*torch.logsumexp(torch.tensor(values) * 200/ T, dim=0))))    
